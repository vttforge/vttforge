...
This Code of Conduct applies within all community spaces (issues, pull requests, discussions, Discord if/when it exists) and also when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported privately to the project maintainers via:

→ **[GitHub private security advisory](https://github.com/vttforge/vttforge/security/advisories/new)** (re-purposed for conduct reports until a dedicated channel exists)
