...
- Updated dependencies [39ca019]
  - @vttforge/types@0.11.1

## 0.14.1

### Patch Changes

- 3dc6f13: `modules`, `actors`, `items` and `journal` take fixtures declared as an
...
- 1ebe47e: `game.actors`, `game.items` and `game.journal` are collections now, not empty
...
- e781741: `game.modules` in the mock answers the rest of a collection: `values`, `keys`,
...
- Updated dependencies [e781741]
  - @vttforge/types@0.9.0

## 0.12.0

### Minor Changes

- d08cd15: `MockFoundry` gained two members, `menus` and `keybindings`, so a hand-written
...
- Updated dependencies [d08cd15]
  - @vttforge/types@0.8.0

## 0.11.0

### Minor Changes

- d4f7d5f: `FoundryContainer` gained four members, so a hand-written stand-in for that
...
- 719fe57: The globals this package declares are typed. They were `any`, and that broke
...
- d64c940: A refused `docker` command now says what Docker said.
...
- Updated dependencies [dbd991a]
  - @vttforge/types@0.6.0

## 0.8.0

### Minor Changes

- 6ea8860: New entry point: `@vttforge/testing/container` boots a real Foundry in Docker,
...
- 86b64fa: `withMockFoundry` hands out a module handle for any id, instead of an empty
  collection.
