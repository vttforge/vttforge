...
The list is short on purpose. Every member is one a real consumer used, not one that only exists in Foundry. Reaching a member that is not here is a cast, and a cast is a sentence you write on purpose.
