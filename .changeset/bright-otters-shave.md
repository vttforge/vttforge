...
Add `@vttforge/types/foundry-api`, which declares every name in Foundry's published API reference: 673 classes, 485 interfaces, 289 functions and 218 type aliases across 112 namespaces.
